...
Данная реализация хоть и рабочая, но некоторые моменты реализованы с алгоритмами которые не обеспечивают линейную сложность. 
Эта ветка не рекомендуется к использованию.
